/**
  * Project Name: Leo's Glass, Windows, & Doors
  * Updated: May 29 2024 with Bootstrap v5.3.3
  * Author: https://www.amydenzer.com
  * License: MIT
*/
...
(function() {
  ...
  function toggleText(event) {
    ...
    const readMoreLink = serviceItem.querySelector('.readmore');

    if (fullText.style.display === 'none' || fullText.style.display === '') {
      fullText.style.display = 'block';
      shortText.style.display = 'none';
      readMoreLink.innerHTML = 'Read less <i class="bi bi-arrow-up"></i>';
    } else {
      fullText.style.display = 'none';
      shortText.style.display = 'block';
      readMoreLink.innerHTML = 'Read more <i class="bi bi-arrow-right"></i>';
    }
  }
